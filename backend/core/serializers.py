...
from .models import Booking, Farmer, Procurement, ProcurementCentre, QueueEntry, Slot

User = get_user_model()

# Naive placeholder for wait-time estimation: position-in-queue * fixed average
# service time. Replace with a real ETA model in a later phase.
PLACEHOLDER_AVG_SERVICE_MINUTES = 5
...
class QueueEntrySerializer(serializers.ModelSerializer):
    ...
    def get_estimated_wait_minutes(self, obj):
        return self.get_position(obj) * PLACEHOLDER_AVG_SERVICE_MINUTES
