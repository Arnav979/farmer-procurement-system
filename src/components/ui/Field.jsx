...
const baseControl =
  'w-full border bg-white px-3 py-3 text-[16px] text-ink placeholder:text-muted/70 min-h-[48px] rounded ' +
  ...
  return (
    <div className={className}>
      <label htmlFor={htmlFor} className="mb-1.5 block text-[15px] font-semibold text-ink">
        {label}{' '}
        {hindiLabel ? <span className="ml-2 font-normal text-muted">{hindiLabel}</span> : null}
        {required ? (
