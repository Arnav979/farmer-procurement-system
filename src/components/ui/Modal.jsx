...
export default function Modal({ open, onClose, title, children, footer }) {
  ...
  return (
    <div className="print-hide fixed inset-0 z-40 flex items-end justify-center bg-ink/50 p-0 sm:items-center sm:p-4">
      ...
      <div
        ...
        aria-modal="true"
        aria-label={title}
        className="relative w-full max-w-lg border border-line bg-white shadow-xl"
      >
