...
const VARIANTS = {
  ...
  secondary: 'bg-white text-brand-700 border-brand-600 hover:bg-brand-50',
  neutral: 'bg-white text-ink border-line hover:bg-paper',
  danger: 'bg-white text-danger-600 border-danger-500 hover:bg-danger-50',
  solidDanger: 'bg-danger-500 text-white border-danger-500 hover:bg-danger-600',
